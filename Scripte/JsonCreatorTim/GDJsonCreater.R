...
GetJson <- function(UrlFronts,UrlBacks,cardnames) {
  ...
  numberOfCardsList = as.numeric(substring(cardnames[[1]], 5, 7))
  numberOfCards = sum(numberOfCardsList)
  
  CardBigIds = seq(from = 1, to = numberOfCards)*100
